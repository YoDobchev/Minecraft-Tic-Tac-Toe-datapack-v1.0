...
execute as @e[type=minecraft:armor_stand,name="6",tag=!block] at @s run setblock ~ ~-1 ~ minecraft:light_blue_concrete
execute as @e[type=minecraft:armor_stand,name="6"] run tag @s add block
