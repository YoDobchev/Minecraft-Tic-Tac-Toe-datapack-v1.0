...
execute as @e[type=minecraft:armor_stand,name="5",tag=!block] at @s run setblock ~ ~-1 ~ minecraft:light_blue_concrete
execute as @e[type=minecraft:armor_stand,name="5"] run tag @s add block
